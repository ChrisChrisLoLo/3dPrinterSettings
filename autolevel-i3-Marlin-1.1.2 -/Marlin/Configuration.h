...
//Z offset needs to manually be calculated by doing the index card test on the nozzle after homing.
//MODIFIED LINE ->#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.5  // Z offset: -below +above  [the nozzle]
